**nc-link-sink-plguin** is a NC-Link interface provider plugin for the MetaAgent.  The plugin runs a NC-Link server in the MetaAgent to serve NC-Link clients according to NC-Link Specification.
